...
Cover: <div align="center">     <table align="center">        <tr>    <td width="50%">   <img width="100%" src="/projects/SMiRL/robotsurprise_stacked.png"> </td> <td width="25%">  <img width="100%" src="/projects/SMiRL/miniGrid/minigrid-maze-random-count.gif">           </td>	</tr> </table></div>
...
Published: International Conference on Learning Representations 2021 (Oral, top 1.8% of submissions)
---
...
<div class="t">
    <table align="center">
        <tr>
    <td>
        <img width="100%" src="/projects/SMiRL/vizdoom/Doom_trained_enough_result.gif">
        </td>
    <td>
    <img width="100%" src="/projects/SMiRL/vizdoom/vizdoom_dtl.gif">
           </td>
	</tr>
        <tr align=center>
        <td>
