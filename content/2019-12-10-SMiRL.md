...
Cover: <div align="center">     <table align="center">        <tr>    <td width="25%">        <video width="100%" controls autoplay>   <source src="http://www.fracturedplane.com/projects/SMiRL/biped/treadmill_surpise_ICM_v3_rewardViz.mp4" type="video/mp4"> Your browser does not support the video tag. </video>        </td>    <td width="25%">    <video width="100%" controls autoplay>   <source src="http://www.fracturedplane.com/projects/SMiRL/biped/pedistal_surpise_v3_rewardViz.mp4" type="video/mp4"> Your browser does not support the video tag. </video> </td> <td width="25%">  <img width="100%" src="http://www.fracturedplane.com/projects/SMiRL/miniGrid/minigrid-maze-random-count.gif">           </td>	</tr> </table></div>
...
<div align="center">
            <img width="600" src="http://www.fracturedplane.com/projects/SMiRL/robotsurprise_stacked.png">
</div>
...
<div align="center">
     <img width="600" src="http://www.fracturedplane.com/projects/SMiRL/SMiRL_Outline.png">
</div>
...
<div class="t">
    <table align="center">
        <tr>
    <td align="center">
        <img width="200" src="http://www.fracturedplane.com/projects/SMiRL/tetris/tetris_ps.gif">
        </td>
    <td>
    <img width="320" src="http://www.fracturedplane.com/projects/SMiRL/miniGrid/minigrid-maze-random-count.gif">
           </td>
	</tr>
        <tr align=center>
        <td>
...
<div class="t">
    <table align="center">
        <tr>
    <td>
        <img width="100%" src="http://www.fracturedplane.com/projects/SMiRL/vizdoom/Doom_trained_enough_result.gif">
        </td>
    <td>
    <img width="100%" src="http://www.fracturedplane.com/projects/SMiRL/vizdoom/vizdoom_dtl.gif">
           </td>
	</tr>
        <tr align=center>
        <td>
...
<div class="t">
    <table align="center">
        <tr>
    <td>
        <video width="320" height="240" autoplay>   <source src="http://www.fracturedplane.com/projects/SMiRL/biped/cliff_surpise_VAE_6_v3_rewardViz.mp4" type="video/mp4">   <source src="movie.ogg" type="video/ogg"> Your browser does not support the video tag. </video>
        </td>
    <td>
    <video width="320" height="240" autoplay>   <source src="http://www.fracturedplane.com/projects/SMiRL/biped/treadmill_surpise_VAE_6_v3_rewardViz.mp4" type="video/mp4">   <source src="movie.ogg" type="video/ogg"> Your browser does not support the video tag. </video>
           </td>
	</tr>
        <tr align=center>
        <td>
...
<div align="center">
     <img width="90%" src="http://www.fracturedplane.com/projects/SMiRL/video_game_comparisons_2.png">
</div>
...
<div align="center">
     <img width="90%" src="http://www.fracturedplane.com/projects/SMiRL/Capture_biped_results.png">
</div>
...
<div class="t">
    <table align="center">
        <tr>
    <td>
        <video width="320" height="240" autoplay>   <source src="http://www.fracturedplane.com/projects/SMiRL/biped/treadmill_surpise_ICM_v3_rewardViz.mp4" type="video/mp4">   <source src="movie.ogg" type="video/ogg"> Your browser does not support the video tag. </video>
        </td>
    <td>
    <video width="320" height="240" autoplay>   <source src="http://www.fracturedplane.com/projects/SMiRL/biped/pedistal_surpise_v3_rewardViz.mp4" type="video/mp4">   <source src="movie.ogg" type="video/ogg"> Your browser does not support the video tag. </video>
           </td>
	</tr>
        <tr align=center>
        <td>
